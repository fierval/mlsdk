...
from .utils import tensorflow_backend as backend
...
class Anchors(keras.layers.Layer):
    ...
    def call(self, inputs, **kwargs):
        ...
        anchors = common.shift(features_shape[1:3], self.stride, self.anchors)
...
class RegressBoxes(keras.layers.Layer):
    ...
    def call(self, inputs, **kwargs):
        ...
        return common.bbox_transform_inv(anchors, regression, mean=self.mean, std=self.std)
